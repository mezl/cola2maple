...
#define SCHOOLNAME	"道明中學"		/* 組織名稱 */
#define BBSNAME		"電腦資訊研究社"		/* 中文站名 */
#define BBSNAME2	".18BBS"		/* 英文站名 */
#define SYSOPNICK	"猴子班長"		/* sysop 的暱稱 */
#define TAG_VALID       "["BBSNAME2"]To"	/* 身分認證函 token */

#define MYIPADDR	"211.23.120.61"		/* IP address */
#define MYHOSTNAME	"bbs.xdrz.org"	/* 網路地址 FQDN */
...
#define	LOG_BMW                 /* lkchu.981201: 編碼記錄處理 */

#ifdef LOG_BMW
#define	RETAIN_BMW		/* itoc.021102: 編碼存證 */
#endif
...
#define	BMW_COUNT		/* itoc.010312: 計算中了幾個編碼 */

#define	BMW_DISPLAY		/* itoc.010313: 顯示之前的編碼 */
...
#define BMW_EXPIRE	60		/* 編碼處理時間(秒) */
#define BMW_PER_USER	5		/* 編碼處理時間內，允許丟幾個編碼 */
#define BMW_MAX		128		/* UCACHE 中 pool 上限 */
#define BMW_LOCAL_MAX	8		/* Ctrl+R 上下所能瀏覽之前編碼個數 */
